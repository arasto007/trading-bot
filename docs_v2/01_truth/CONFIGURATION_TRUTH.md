...
| Phase 37 long-horizon tape | `run_phase37_collection()` | n/a | RESEARCH/data-acquisition; attach-only XAUUSD_i M5; never overwrite frozen Phase 28 snapshot | **BLOCKED** — terminal BLOCKED; Phase 38 not started |
